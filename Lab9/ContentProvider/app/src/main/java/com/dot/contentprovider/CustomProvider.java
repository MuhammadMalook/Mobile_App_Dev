...
public class CustomProvider extends ContentProvider {
    ...
    static {
        myUri.addURI(AUTHORITY,"dictionary",EMP);
        myUri.addURI(AUTHORITY,"dictionary/#",EMP_ID);
    ...
    private class MyOwnDatabase extends SQLiteOpenHelper
    {
        ...
        public void onCreate(SQLiteDatabase sqLiteDatabase) {
            sqLiteDatabase.execSQL("create table "+DB_TABLE+ "(word TEXT,description TEXT)");
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        //Toast.makeText(getContext(), "insert "+row, Toast.LENGTH_SHORT).show();
        if(row>0)
        {
            uri = ContentUris.withAppendedId(CONTENT_URI,row);
            getContext().getContentResolver().notifyChange(uri,null);
           // Toast.makeText(getContext(), "word added "+row, Toast.LENGTH_SHORT).show();
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        Cursor cr = myQuery.query(myDb,null,null,null,null,null,null);
