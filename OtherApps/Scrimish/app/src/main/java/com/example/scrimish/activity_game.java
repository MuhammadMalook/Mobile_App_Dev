...
public class activity_game extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        images = new int[]{R.drawable.crown,R.drawable.one,R.drawable.two,R.drawable.three,R.drawable.four,R.drawable.five,R.drawable.six,R.drawable.archer,R.drawable.sheild};

        player1 = findViewById(R.id.textView14);
        SharedPreferences preferences = getSharedPreferences("players",MODE_PRIVATE);
        player1.setText(preferences.getString("player1","player 1") + " Cards");
