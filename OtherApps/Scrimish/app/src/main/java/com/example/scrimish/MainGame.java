...
public class MainGame extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        player1Name.setText(preferences.getString("player1","player1"));
        player2Name.setText(preferences.getString("player2","player2"));
        ...
        turnLabel.setText(player1Name.getText().toString()+" turn ");
...
//        }).show();
        if(user_1)
            turnLabel.setText(player2Name.getText().toString()+" turn ");
        else
            turnLabel.setText(player1Name.getText().toString()+" turn ");
        user_1 = !user_1;
    }
