...
public class DBhelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String query = "CREATE TABLE students (Name TEXT, Phone TEXT, Street TEXT,Email TEXT,City TEXT)";
        db.execSQL(query);
    }
    ...
    {
        SQLiteDatabase db = getReadableDatabase();
        String query = "UPDATE students SET Name='"+name+"',Phone='"+phone+"', Street='"+street+"' , Email = '"+email+"' , City='"+city+"' WHERE Name='"+oldname+"'";
        db.execSQL(query);
    }
}
